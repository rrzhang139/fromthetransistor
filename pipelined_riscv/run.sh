...
iverilog -g2012 -o "out/${filename}.out" ${filename}.sv ${filename}_tb.sv id.sv ex.sv wb.sv pc.sv ctl.sv immgen.sv branchcmp.sv regfile.sv alu.sv dmem.sv imem.sv dram.sv hazardDetection.sv riscv_def.sv
